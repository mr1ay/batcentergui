        ...
        set pagebutton= 2  22 9 22 
        set colorpagebutton= 0c   
        batbox.exe /g 10 22  /c 0x0a /d "Page2"  
        set pagebutton= 2  22 9 22  10 22 17 22 
        set colorpagebutton= 0c    0c   
        ...
        GetInput /M %navbarloc%  %colorline%  %pagebutton%  /H %navbarhover%  %colorlinehover% %colorpagebutton%
               ...
               if %errorlevel% equ 25  echo.1>_selectpage.mr1ay && call page1.bat
               if %errorlevel% equ 26  echo.2>_selectpage.mr1ay && call page2.bat
